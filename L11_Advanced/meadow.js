...
(function (L11_Advanced) {
    ...
    function handleLoad() {
        ...
        for (let i = 0; i < 20; i++) {
            ...
            let flower = new L11_Advanced.Flower(centerX, centerY, radius, 5, color, (Math.random() - 0.009) * 0.02);
            flowers.push(flower);
        }
        drawFlowers();
        ...
        for (let i = 0; i < 5; i++) {
            ...
            let bee = new L11_Advanced.Bee(canvas.width * 0.5, canvas.height * 0.5, randomSpeedX, randomSpeedY, randomScale);
            moveables.push(bee);
        }
        drawMoveables();
        update();
    ...
    // draw grass
    function drawGrass() {
        L11_Advanced.crc2.fillStyle = "cadetblue";
        L11_Advanced.crc2.fillRect(0, (L11_Advanced.crc2.canvas.height / 2), L11_Advanced.crc2.canvas.width, (L11_Advanced.crc2.canvas.height / 2));
    }
    ...
    function drawMountains() {
        ...
        L11_Advanced.crc2.fillStyle = gradient;
        L11_Advanced.crc2.moveTo(500, 500);
        L11_Advanced.crc2.quadraticCurveTo(100, -100, -200, 500);
        L11_Advanced.crc2.moveTo(1500, 500);
        L11_Advanced.crc2.quadraticCurveTo(700, -200, 300, 500);
    ...
    function drawSun() {
        L11_Advanced.crc2.beginPath();
        L11_Advanced.crc2.arc(Math.random() * width + 100, height / 4, 100, 0, 2 * Math.PI);
